...
#define BAT_LOW_LVL1            3.3       // gently beeps at this voltage level. [V/cell]
...
#define DEBUG_SERIAL_FEEDBACK	//XXX

// ############################### INPUT ###############################

// ###### CONTROL VIA UART (serial) ######
//#define CONTROL_SERIAL_NAIVE_USART2	//XXX               // left sensor board cable, disable if ADC or PPM is used!
...
//  #define SERIAL_USART3_IT                          // Interface for CONTROL_SERIAL_PROTOCOL
  ...
  #define WHEEL_SIZE_INCHES 10.33	//XXX                      // - set to your wheelsize to override the default 6.5

// ###### CONTROL VIA RC REMOTE ######
// left sensor board cable. Channel 1: steering, Channel 2: speed.
////XXX #define CONTROL_PPM                 // use PPM-Sum as input. disable DEBUG_SERIAL_USART2!
//#define PPM_NUM_CHANNELS 6          // total number of PPM channels to receive, even if they are not used.

// ###### CONTROL VIA TWO POTENTIOMETERS ######
// ADC-calibration to cover the full poti-range: connect potis to left sensor board cable (0 to 3.3V) (do NOT use the red 15V wire in the cable!). see <How to calibrate>. turn the potis to minimum position, write value 1 to ADC1_MIN and value 2 to ADC2_MIN. turn to maximum position and repeat it for ADC?_MAX. make, flash and test it.
//XXX #define CONTROL_ADC               // use ADC as input. disable DEBUG_SERIAL_USART2!
...
////XXX #define CONTROL_NUNCHUCK            // use nunchuck as input. disable DEBUG_SERIAL_USART3!
